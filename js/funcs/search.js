...
const showSearchResultCoursesAndArticle = async ()=>{
    ...
    if(resultSearch.allResultCourses.length){
        resultSearch.allResultCourses.forEach(course => {
            console.log(course);
    ...
    if(resultSearch.allResultArticles.length){
        resultSearch.allResultArticles.forEach(article =>{
      ...
      `)
        ...
        articleWrapper.insertAdjacentHTML('beforeend' , `
            <p class="text-danger">مقاله ای یافت نشد</p>
            `)
    }
}

export {showSearchResultCoursesAndArticle}