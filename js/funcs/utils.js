...
const insertCourseBoxHtml = (arr , parent) => {
    arr.forEach(course => {
        parent.insertAdjacentHTML('beforeEnd' ,`
                      ...
                      <a href="course.html?name=${
                        ...
                        <div class="courses-box__status">
                          ...
                          <div class="courses-box__user">
                            ...
                            <p class="courses-box__user-text">${
                              course.registers
                            }</p>
                          </div>
                        </div>
...
export {showSwal , setToLocalStorage , getToLocalStorage , getToken , isLogin , getUrlParamInUrl , paginateItem , insertCourseBoxHtml}